...
--
-- Servidor: 127.0.0.1
-- Tiempo de generaci&oacute;n: 27-10-2014 a las 17:18:29
...
('SAMM', 'Malarg&utilde;e', 'Mendoza', 'Aeropuerto Internacional Comodoro Ricardo Salom&oacute;n'),
...
('SASA', 'Salta', 'Salta', 'Aeropuerto Internacional Mart&iacute;n Miguel de G&utilde;emes'),
('SASJ', 'Perico', 'Jujuy', 'Aeropuerto Internacional Gobernador Horacio Guzm&aacute;n'),
('SASO', 'San Ram&oacute;n de la Nueva Or&aacute;n', 'Salta', 'Aero Club Or&aacute;n'),
...
ALTER TABLE `pasajero`
 ADD PRIMARY KEY (`dni`), ADD KEY `reserva` (`reserva`);

--
-- Indices de la tabla `reserva`
--
ALTER TABLE `reserva`
 ADD PRIMARY KEY (`codigoReserva`), ADD UNIQUE KEY `codigo` (`codigoReserva`,`dniPasajero`), ADD KEY `codigoAvion` (`dniPasajero`), ADD KEY `codigoDestino` (`codVuelo`), ADD KEY `dniPasajero` (`dniPasajero`), ADD KEY `codVuelo` (`codVuelo`);
